define(["knockout"], function(ko) {
    ...
    var Column = function(params) {
        ...
        this.sortable = ko.observable(params.sortable !== false);
    ...
    Column.prototype.orderBy = function() {
    ...
    Column.createColumns = function(params) {
        ...
        columns.orderBy = function() {
            var orderFields = [];
            ko.utils.arrayForEach(columns(), function(column) {
                var result = column.orderBy();
                if(result) {
                    orderFields.push(result);
                }
            });
